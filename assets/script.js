...
var citiesContainer = document.getElementById("previous-searches");
// Added all Five-Day variables. Could not use for loop due to API data being
...
function getWeatherData(lat, lon, city) {
  var urlAPI =
    ...
    "&lon=" +
    lon +
    "&exclude=hourly&units=imperial&appid=9674a6a8f4915aca684dd5788eec83bf";
